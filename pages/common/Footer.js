              ...
              <div className="w-full lg:w-1/2 mb-16 lg:mb-0 flex">
                <div className="w-full lg:w-1/2 px-6">
                  <ul>
                    <li>
                      <Link href="#">
                        <a className="text-xs lg:text-sm leading-none hover:text-indigo-600 hover:text-brand dark:hover:text-brand text-gray-800 dark:text-gray-50">
                          Components
                        </a>
                      </Link>
                    </li>
                    ...
                    <li className="mt-6">
                      <a
                        href="#"
                        className="text-xs lg:text-sm leading-none hover:text-indigo-600 hover:text-brand dark:hover:text-brand text-gray-800 dark:text-gray-50"
                      >
                        Documentation
                      </a>
                    </li>
